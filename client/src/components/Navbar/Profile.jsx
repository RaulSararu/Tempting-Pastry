    ...
    <div className='leftBlock'>
      <div>
        ...
        <div className='formProf'>
            <h4> <span ><MdManageAccounts style={{fontSize:'30px'}}/> </span>User Profile</h4>
        <div><label>Email</label><br/><input readOnly value={currentUser.email}/></div>
        <div><label>Username</label><br/><input readOnly value={currentUser.username}/></div>
